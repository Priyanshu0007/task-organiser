...
const types=[
    ...
    },
    {
        id:"inprogress",
        name:"In Progress",
        description:"A new that is currently being worked on",
        color:"bg-yellow-500"
    },
    {
        id:"done",
            ...
            <RadioGroup value={newTaskType} onChange={(e)=>{setNewTaskType(e)}}>
                <div className='space-y-2'>
                    {types.map((type)=>(
                        ...
                        ${active?"rind-2 ring-white ring-opacity-60 ring-offset-2 ring-offset-sky-300":""}
                        ${checked?`${type.color} bg-opacity-75 tect-white`:'bg-white'}
