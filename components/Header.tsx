...
const Header = () => {
  ...
  return (
    <header>
        ...
        <Image src='https://seeklogo.com/images/T/todoist-logo-2C2FBDF0F0-seeklogo.com.png' alt='logo' height={100} width={300} className='w-44 md:w-56 pb-10 mb:pb-0 object-contain' />
