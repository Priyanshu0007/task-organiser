                    ...
                    {(provided,snapshot)=>(
                        ...
                        >
                            <h2 className='flex justify-between font-bold text-xl mb-2'>
                                {idToColumnText[id]}
                                <span className='text-gray-500 bg-gray-200 rounded-full px-2 py-1 text-sm '>{!searchString?todos.length:todos.filter(todo=>todo.title.includes(searchString)).length}</span>
                            </h2>
